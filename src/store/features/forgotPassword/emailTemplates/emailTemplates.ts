export const emailTemplates = `<!doctype html>
<html lang="en-US">
...
<body style="background-color:#f9f9f9;">
    ...
    <div style="background-color:#f9f9f9;">
      ...
      <![endif]-->
        ...
        <div style="background:#f9f9f9;Margin:0 auto;max-width:600px;">

            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#f9f9f9;width:100%;">
                <tbody>
                    <tr>
                        <td style="border-bottom:#333957 solid 5px;direction:ltr;font-size:0;padding:20px 0;text-align:center;vertical-align:top;">
                            <!--[if mso | IE]>
      ...
      <![endif]-->
        ...
        <div style="background:#fff;Margin:0 auto;max-width:600px;">
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#fff;width:100%;">
                <tbody>
                    <tr>
          ...
          <![endif]-->
                            ...
                            <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:bottom;width:100%;">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:bottom;" width="100%">
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:128px;">
                                                            ...
                                                            <img height="auto" src="https://i.imgur.com/247tYSw.png" style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="128";alt="iconka" />
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0;padding:10px 25px;padding-top:30px;padding-bottom:50px;word-break:break-word;">
                                                ...
                                                <tr>
                                                    <td align="center" bgcolor="#2F67F6" role="presentation" style="border:none;border-radius:3px;color:#ffffff;cursor:auto;padding:15px 25px;" valign="middle">
                                                        <p style="background:#2F67F6;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                            <a style="text-decoration:none;color:#fff" href='https://alexnewhere.github.io/friday-project/#/password/$token$'>Create new Password</a>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
